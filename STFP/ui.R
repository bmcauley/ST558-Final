        ...
        fluidRow(column(
          ...
          tags$ul(
            ...
            tags$li(
              ...
              code("Build"),
              ");
                                         and options to select variables and obtain a prediction for the response (",
              code("Predict"),
              ")."
            ),
      ...
      tabPanel(
        ...
        sidebarLayout(
          sidebarPanel(
            ...
            h6(
              em(
                "Use the options below to generate custom numerical summaries of the data."
              )
            ),
      ...
      tabPanel(
        ...
        tabsetPanel(
          tabPanel(
            ...
            h6(
              em(
                "Before jumping into configuring your own models, read the information
          ...
          tabPanel(
            ...
            fluidRow(
              column(
                ...
                wellPanel(
                  h6(
                    "Use the slider below to set the proportion by which
                        you want to split the training and test data, respectively."
                  ),
                  sliderInput(
                    "prop",
                    label = h6("Split Proportion"),
                    min = 0,
                    max = 1,
                    value = 0.7,
                    step = 0.05
                  ...
                  conditionalPanel(condition = "input.prop == 0",
                                   h6(em(
                                     "So...build a model on nothing, then?"
                                   ))),
                  
                  conditionalPanel(condition = "input.prop == 1",
                                   h6(
                                     em("So...what is the model going to test on, exactly?")
                                   )),
              ...
              column(
                ...
                wellPanel(
                  ...
                  HTML("<em>I'm not the most robust algorithm; if my <code>cp</code>
              ...
              sidebarPanel(
                ...
                HTML(
                  "<h6>Use the fields below to set your desired values of the predictor variables
                                 included in the model generated on <em>Build</em> tab.</h6>

                       <h6>Click the <em><b>Predict</b></em> button at the bottom of the panel to obtain a prediction.</h6>"
                ),
          ...
          mainPanel(span(textOutput("logGuess"), style="color:blue;
                         font-size: 20px"))
        )
      )
    )
      ...
      sidebarPanel(
        HTML(
          " <em><h6>
                                    ...
                                    <h6>
                                    Use the <b>Filter</b> box to enter a query to subset the rows by. For multiple
          conditions, use <b>&</b> (And) or <b>|</b> (Or) between expressions.
                                  </h6>
        ...
        actionButton("updateTbl", "Update", icon = icon("rotate-right"), style = "color: #000; background-color: #fff; border-color: #000"),
        
        downloadButton("employData", "Save", style = "color: #000; background-color: #fff; border-color: #000")
      ),
